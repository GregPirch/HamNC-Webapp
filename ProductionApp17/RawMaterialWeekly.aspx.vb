...
Partial Class RawMaterialWeekly
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If IsPostBack = False Then
                ...
                cmd.CommandText = "sp_Return5WeeksOfRawMaterialUsage"
                ...
                Try
                    ...
                    sDate = Left(sDate, 4) + "-" + Mid(sDate, 5, 2) + "-" + Right(sDate, 2)
                    GridView1.HeaderRow.Cells(3).Text = sDate

                    sDate = Replace(Replace(row.Cells(4).Text, ".0", ""), ",", "")
                    sDate = Left(sDate, 4) + "-" + Mid(sDate, 5, 2) + "-" + Right(sDate, 2)
                    GridView1.HeaderRow.Cells(4).Text = sDate

                    GridView1.HeaderRow.Cells(5).Text = Me.lLastDate.Text
    ...
    Protected Sub BtnGetMonthBefore_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            ...
            DateToShow = CType(Session("glbDateToShow"), Date)
            DateToShow = DateToShow.AddDays(-7 * 5)
            Session("glbDateToShow") = CType(DateToShow, String)
